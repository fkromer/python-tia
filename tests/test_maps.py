...
class TestCoverageMap:
    def test_get_production_files_from_changed_test_files(self):
...
class TestImpactMap:
    def test_get_tests_impacted_by_changed_production_code_files(self):
        db_path = 'tests/data/.coverage'
        ...
        assert sorted(first_impact_mapping.tests) == sorted([
            ...
            'test_read_valid_parent_key_config',
            'test_read_valid_explicit_full_blown_pipelines_config',
